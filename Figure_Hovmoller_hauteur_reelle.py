...
#15/11/2022 : Ajout hauteur réelle à partir de la lecture des fichier de tide prédites à Hon Dau.
import csv
import pandas as pd
import numpy as np
...
if month=='06':
    ...
    nb_bin=45
    y=np.linspace(0,140,5) # TODO : a refaire, revoir la méthode
    prof=['-14', '-10.5', '-7', '-3.5' ,'0'] #TODO : ticks plus lisible
    #transect=['fixed']
elif month=='08':
...
for t in transect :
    if t == 'T1' :
        day='16'
        stations=['J1', 'J2', 'J3','J4', 'J5', 'J6', 'J7' , 'J8', 'J9', 'J10', 'J11']
        x=np.arange(0,11,1)
    elif t=='T2' :
        day='16'
        stations=['J12', 'J14', 'J15', 'J16', 'J17']
        x=np.arange(0,5,1)
    elif t=='T3' :
        day='17'
        stations=['J18', 'J19', 'J20','J21', 'J22', 'J23', 'J24' , 'J25', 'J26', 'J27', 'J28']
        x=np.arange(0,11,1)
    elif t=='T4' :
        day='17'
        stations=['J29', 'J30','J31', 'J32', 'J33', 'J34' , 'J35', 'J37', 'J38', 'J39']
        x=np.arange(0,10,1)
    elif t=='fixed':
        day='18'
        #stations=['1']
    ...
    fig, axs = plt.subplots(nrows=len(variable))
